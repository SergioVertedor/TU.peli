...
public class PaneListadoGeneroController {
  ...
  @FXML private ImageView imgResultado42;
  @FXML private ImageView imgResultado43;
  ...
  @FXML private ImageView imgResultado46;
	...
	@FXML	private Label lblGenero1;
	@FXML	private Label lblGenero2;
	@FXML	private Label lblGenero3;
	@FXML	private Label lblGenero4;

  // Contenedores VBox de los resultados 
	@FXML	private VBox line0;
	@FXML	private VBox line1;
	@FXML	private VBox line2;
	@FXML	private VBox line3;
	@FXML	private VBox line4;
	
  @FXML
  void goToTitulo(MouseEvent event) {
  	// Va al detalle del titulo/imagen seleccionado
  }
