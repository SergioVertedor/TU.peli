...
public class PantallaModeloController {
    ...
    void initialize() {
        ...
        assert lblPeliculas != null : "fx:id=\"lblPeliculas\" was not injected: check your FXML file 'PantallaModelo.fxml'.";
        assert lblProximamente != null : "fx:id=\"lblProximamente\" was not injected: check your FXML file 'PantallaModelo.fxml'.";
